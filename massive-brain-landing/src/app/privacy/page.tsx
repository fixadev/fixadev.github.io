export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-white">
      ...
      <p className="mb-4">Last updated: February 24, 2025</p>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          <p>
            <strong>Application</strong> refers to MassiveBrain, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Pixa, Inc., 1395 22nd St, Apt 857.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>
          ...
          <a
            href="http://massivebrain.ai/privacy"
            rel="external nofollow noopener"
            target="_blank"
            className="underline hover:opacity-80"
          >
            http://massivebrain.ai/privacy
          </a>
        </li>
      </ul>
    </div>
